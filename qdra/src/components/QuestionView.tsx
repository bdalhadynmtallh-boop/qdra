...
import { CheckCircle2, XCircle, Star, ArrowLeft, Bot } from "lucide-react";
...
interface QuestionViewProps {
  ...
  // 🎓 اسأل المعلم الذكي عن هذا السؤال تحديداً
  // نمرر السؤال كاملاً حتى يتوفر للمعلم:
  // السؤال + الخيارات + الإجابة + التصنيف + قطعة الاستيعاب
  onAskTeacher?: (question: Question) => void;
}
...
export default function QuestionView({
  ...
  const displayCategory =
    category ||
    (question as Record<string, any>).category;
  ...
  return (
    <div className="animate-fade-in-up mx-auto w-full max-w-2xl">
              ...
              (_, i) => {
                ...
                return (
                  <button
                    ...
                    aria-label={`الانتقال إلى السؤال ${
                      i + 1
                    }`}
                    className={cn(
      ...
      <div className="glass-card rounded-3xl p-5 md:p-7">
        ...
        ========================================================= */}
        {question.passage && (
          <div className="mb-4 rounded-2xl border border-ink-50/5 bg-ink-950/30 p-4 text-sm leading-8 text-ink-200 whitespace-pre-wrap">
            {question.passage}
          </div>
        )}
              ...
              if (hideResultImmediately) {
                ...
                if (answered) {
                  if (isRight) {
                    ...
                    stateClasses =
                      "border-ink-50/5 bg-ink-50/[0.02] opacity-50";
                  }
                }
              }
                ...
                <div className="space-y-3">
                  ...
                  {question.explanation && (
                    <div className="rounded-2xl border border-gold-500/20 bg-gold-500/5 p-4">
                      ...
                      <p className="mb-2 text-xs font-bold text-gold-300">
                        الشرح
                      </p>
        ...
        {onAskTeacher && (
          <div className="mt-5">
            ...
            <button
              ...
              className="press flex w-full items-center justify-center gap-2 rounded-2xl border border-gold-500/30 bg-gold-500/10 px-4 py-3 text-sm font-bold text-gold-300 transition hover:bg-gold-500/20"
            >
              <Bot size={18} />
              اسأل المعلم الذكي عن هذا السؤال
            </button>
